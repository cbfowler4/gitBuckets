...
var Nodes = function () {
  ...
  _createClass(Nodes, [{
    ...
    value: function updateNodeValues() {
      ...
      _store2.default.seasonData[String(_store2.default.selectedYear)].forEach(function (team, i) {
        var newObj = {
          radius: team.w * .7,
