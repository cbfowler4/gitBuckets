...
var Nodes = function () {
  ...
  _createClass(Nodes, [{
    ...
    value: function createNodes() {
      var nodes = this.seasonData[2014].map(function (team) {
        return {
          radius: team[0].w * .7,
...
var TeamContainer = function (_React$Component) {
  ...
  function TeamContainer(props) {
    ...
    return _possibleConstructorReturn(this, (TeamContainer.__proto__ || Object.getPrototypeOf(TeamContainer)).call(this, props));
  }
